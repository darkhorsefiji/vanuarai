...
export const THEME_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        k: "--nav-active-bg",
        l: "Active background (current page)",
        t: "color",
        d: "#ffffff",
      },
  ...
  },
  {
    ...
    items: [
      {
        k: "--sc-phrase-size",
        l: "Phrase font size (scales all levels)",
        t: "range",
        d: "13.5",
        min: 10,
        max: 22,
      ...
      { k: "--sc-phrase-color", l: "Phrase colour", t: "color", d: "#0c4651" },
      {
        k: "--sc-phrase-weight",
        l: "Phrase weight",
        t: "range",
  ...
  {
    group: "Scorecard pills",
    items: [
      {
        k: "--sc-pill-initiative-bg",
        l: "Initiative colour",
        t: "color",
        d: "#0e98a5",
      },
      {
        k: "--sc-pill-project-bg",
        l: "Project colour",
        t: "color",
        d: "#f4a72c",
      },
      { k: "--sc-pill-text", l: "Pill text colour", t: "color", d: "#ffffff" },
      {
        k: "--sc-pill-size",
        l: "Pill font size",
        t: "range",
  ...
  {
    group: "Resolution pills",
    items: [
      {
        k: "--pill-approved-bg",
        l: "Approved background",
        t: "color",
        d: "#daeee4",
      },
      {
        k: "--pill-approved-text",
        l: "Approved text",
        t: "color",
        d: "#2f7a52",
      },
      {
        k: "--pill-rejected-bg",
        l: "Rejected background",
        t: "color",
        d: "#f5e2de",
      },
      {
        k: "--pill-rejected-text",
        l: "Rejected text",
        t: "color",
        d: "#a83b25",
      },
      {
        k: "--pill-deferred-bg",
        l: "Deferred background",
        t: "color",
        d: "#fdefd9",
      },
      {
        k: "--pill-deferred-text",
        l: "Deferred text",
        t: "color",
        d: "#9a6a12",
      },
      {
        k: "--pill-withdrawn-bg",
        l: "Withdrawn background",
        t: "color",
        d: "#eef1f1",
      },
      {
        k: "--pill-withdrawn-text",
        l: "Withdrawn text",
        t: "color",
        d: "#5b6b6f",
      },
