...
export const PERSPECTIVES = [
  {
    ...
    objective:
      "Rising family income and a growing Gross Village Product (GVP).",
    kpis: [
      { t: "Gross Village Product (GVP) — headline indicator", p: 3, u: "FJD" },
      { t: "Average family income", p: 3, u: "FJD", r: "avg" },
      {
        t: "Co-operative revenue (FJD captured of the 42.7M target)",
        p: 3,
        u: "FJD",
      },
  ...
  {
    key: "vanua",
    tier: "Stakeholder / Community",
    accent: "var(--pop)",
    title: "Vanua & Nation",
    objective:
      "Import substitution delivered; dependency replaced by abundance.",
    kpis: [
      { t: "Share of the 10%-in-10-years target captured", p: 3, u: "FJD" },
      { t: "Volume supplied to the Co-operative / miller", p: 3, u: "kg" },
      {
        t: "Children's welfare outcomes (the Trust's mandate)",
        p: 2,
        u: "index",
        r: "avg",
      },
      {
        t: "Government collaboration outputs (Provincial Office, TAB)",
        p: 5,
        u: "count",
      },
      {
        t: "Households with a disaster-preparedness plan",
        p: 4,
        u: "households",
      },
  ...
  },
  {
    ...
    kpis: [
      ...
      {
        t: "Sustainable marine & forest harvest practices adopted",
        p: 4,
        u: "practices",
      },
      ...
      {
        t: "Conformance to the Trust's quality standards",
        p: 1,
        u: "%",
        r: "avg",
      },
  ...
  {
    key: "family",
    tier: "Foundation · Learning & Growth",
    accent: "var(--sage)",
    ...
    kpis: [
      ...
      {
        t: "Family cohesion — weekly soli & family devotion",
        p: 2,
        u: "people",
      },
    ],
...
export const PLATFORMS = [
  ...
  {
    n: 4,
    name: "Conservation of Natural Resources & Climate Change Adaptation",
    thrust: "transformational",
  },
...
export const THRUSTS = [
  {
    key: "inclusive",
    name: "Inclusive Socio-Economic Development",
    priorities: [
...
export function kpisForPlatform(n) {
  ...
  for (const persp of PERSPECTIVES)
    for (const k of persp.kpis)
      if (k.p === n)
        out.push({ t: k.t, perspective: persp.title, accent: persp.accent });
  return out;
}
...
export const COMMODITIES = [
  {
    rank: 1,
    product: "Wheat flour & baked goods",
    imp: 145.0,
    note: "Wheat flour, bread, biscuits, pasta",
  },
  {
    rank: 2,
    product: "Coconut oil & milk (lolo)",
    imp: 92.0,
    note: "Vegetable oils + canned coconut",
  },
  { rank: 3, product: "Coffee", imp: 18.5, note: "Roasted, instant & ground" },
  {
    ...
    imp: 12.8,
    note: "Cocoa powder, chocolate, confectionery",
  },
  {
    rank: 5,
    product: "Kava (Yaqona)",
    imp: 9.4,
    note: "Mainly lower-grade imported kava",
  },
  {
    rank: 6,
    product: "Cassava flour & starch",
    imp: 27.0,
    note: "Starches, tapioca & flour substitutes",
  },
  {
    rank: 7,
    product: "Ginger & turmeric",
    imp: 6.2,
    note: "Dried spices & fresh rhizomes",
  },
  {
    rank: 8,
    product: "Tropical fruit purees & juices",
    imp: 48.0,
    note: "Juices, concentrates & purees",
  },
  { rank: 9, product: "Vanilla", imp: 3.1, note: "Cured beans & extracts" },
  {
    rank: 10,
    product: "Root-crop snacks & chips",
    imp: 65.0,
    note: "Potato chips, extruded snacks & crisps",
  },
];
...
export const CASCADE = [
  {
    level: "vuvale",
    role: "The production cell & nursery of character",
    actions: [
  ...
  {
    level: "yavusa",
    role: "Accountability & delivery — the Turaga ni Yavusa",
    actions: [
  ...
  {
    level: "vanua",
    role: "Strategy, platforms & partnerships — Cakaudrove",
    actions: [
