...
export function GoogleButton() {
  ...
  if (!CLIENT_ID)
    return <span className="authnote">Google login not configured</span>;
  return <div ref={ref} />;
}
...
export default function AuthArea() {
  ...
  return (
    <span className="authbox" ref={wrapRef}>
      <span className="rolepill" title="Your role">
        {role}
      </span>
      <button
        className="avatar"
      ...
      {open && (
        <div className="usermenu" role="menu">
          ...
          {(isVillageAdmin(user) || isDev(user)) && (
          ...
          <button
            className="usermenu-item"
            role="menuitem"
            onClick={() => openModal("Payment Preferences")}
          >
            Payment Preferences
          </button>
          <button
