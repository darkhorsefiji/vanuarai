...
|-----|------|--------|--------|
| CHG-0028 | 2026-07-02 | _this commit_ | Strategy page: remove the old BSC live scorecard (superseded by the Outcome Framework); page is now the pure strategy framework |
