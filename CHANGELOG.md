...
|-----|------|--------|--------|
| CHG-0026 | 2026-07-02 | _this commit_ | Outcome Framework — API (`/api/of/*`): taxonomies; outcome / indicator / measurement CRUD with the recursive roll-up + generated variance; actions (task/intervention/project) with auto ref-codes (INT/TSK/PRJ/CHL), polymorphic RACI, Task→Intervention integrity, completion guard and outcome link; intervention-indicators; challenges + overdue view. Village-admin gated; 17-check smoke test green |
